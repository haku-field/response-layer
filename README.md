...
This fragment functions as a **bridge-layer**.
It maps upper-layer relational principles into response-structure control,
treating response as a **byproduct of relation**, not an objective.
...
Direct control targets are limited to:
RET-envelope, gesture-kernel, unfinished-region, observations-for-ai.
